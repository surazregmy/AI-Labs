...
maxDoc1 = termCMatrix['doc1'].max{it.value}.value //maximum num of count in doc1
maxDoc2 = termCMatrix['doc2'].max{it.value}.value //maximum num of count in doc2
maxQuery = termCMatrix['query'].max{it.value}.value //maximum num of count in query  
...
union.each{
    df[it] = termFMatrix['doc1'][it] + termFMatrix['doc2'][it] + termFMatrix['query'][it]
}
...
println "Cosine of doc 1 : "+cosine1+" Cosine of doc 2 : "+cosine2;
if(cosine1>cosine2){
    println "Query is more similar with DOC 1"
}else{
    println "Query is more similar with DOC 2"
}
